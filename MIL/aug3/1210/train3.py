...
class RecursiveFeatureDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 形狀處理
        if feature.dim() == 3: feature = feature[0, 0, :] 
        elif feature.dim() == 2: feature = feature[0, :]
        elif feature.dim() == 1 and feature.shape[0] > 768: feature = feature[:768]
...
class MLPClassifier(nn.Module):
    def __init__(self, in_dim=768, hidden1=256, hidden2=64, num_classes=3, dropout=0.25):
        super().__init__()
...
save_dir = f"results/train3_{timestamp}"
